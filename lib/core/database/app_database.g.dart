...
class $SavedBooksTable extends SavedBooks
  ...
  static const VerificationMeta _encodingConfidenceMeta =
      const VerificationMeta('encodingConfidence');
  @override
  late final GeneratedColumn<double> encodingConfidence =
  ...
  static const VerificationMeta _userForcedEncodingMeta =
      const VerificationMeta('userForcedEncoding');
  @override
  late final GeneratedColumn<String> userForcedEncoding =
      GeneratedColumn<String>(
...
class SavedBook extends DataClass implements Insertable<SavedBook> {
  ...
  SavedBooksCompanion toCompanion(bool nullToAbsent) {
    return SavedBooksCompanion(
      ...
      externalUri: externalUri == null && nullToAbsent
          ? const Value.absent()
          : Value(externalUri),
  ...
  SavedBook copyWithCompanion(SavedBooksCompanion data) {
    return SavedBook(
      ...
      coverStatus: data.coverStatus.present
          ? data.coverStatus.value
          : this.coverStatus,
      ...
      encodingConfidence: data.encodingConfidence.present
          ...
          : this.encodingConfidence,
      encodingSource: data.encodingSource.present
          ? data.encodingSource.value
          : this.encodingSource,
...
class SavedBooksCompanion extends UpdateCompanion<SavedBook> {
  ...
  static Insertable<SavedBook> custom({
    ...
    return RawValuesInsertable({
      ...
      if (userForcedEncoding != null)
        'user_forced_encoding': userForcedEncoding,
...
class $AuthorsTable extends Authors with TableInfo<$AuthorsTable, Author> {
  ...
  static TypeConverter<List<String>, String> $converterbookIds =
      const StringListConverter();
}
...
class Bookmark extends DataClass implements Insertable<Bookmark> {
  ...
  Bookmark copyWith({
    ...
    highlightStyle: highlightStyle.present
  ...
  Bookmark copyWithCompanion(BookmarksCompanion data) {
    return Bookmark(
      ...
      highlightStyle: data.highlightStyle.present
          ? data.highlightStyle.value
          : this.highlightStyle,
...
class BookTag extends DataClass implements Insertable<BookTag> {
  ...
  BookTag copyWith({String? bookId, String? tagId, DateTime? addedAt}) =>
      BookTag(
        bookId: bookId ?? this.bookId,
...
class $ReadingTimeTable extends ReadingTime
    with TableInfo<$ReadingTimeTable, ReadingTimeData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  TextHighlight copyWithCompanion(TextHighlightsCompanion data) {
    return TextHighlight(
      ...
      selectedText: data.selectedText.present
          ...
          : this.selectedText,
      color: data.color.present ? data.color.value : this.color,
      decoration: data.decoration.present
          ? data.decoration.value
          : this.decoration,
      noteText: data.noteText.present ? data.noteText.value : this.noteText,
      isOrphaned: data.isOrphaned.present
          ? data.isOrphaned.value
          : this.isOrphaned,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
    );
...
class $$PerBookSettingsTableFilterComposer
...
class $$TextHighlightsTableFilterComposer
...
class $$TextHighlightsTableOrderingComposer
    extends Composer<_$AppDatabase, $TextHighlightsTable> {
